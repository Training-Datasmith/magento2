 ...
 */
class Orders extends Dashboard implements Http_Post_Action_Interface
{
    /**
     * @var JsonFactory
     */
    ...
    {
        $data = ['data' => $this->chart->get_by_period($this->_request->get_param('period'), 'quantity', $this->_request->get_param('store'), $this->_request->get_param('website'), $this->_request->get_param('group')), 'label' => __('Quantity')];
