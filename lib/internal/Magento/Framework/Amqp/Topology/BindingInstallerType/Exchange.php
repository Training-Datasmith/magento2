 ...
 * {@inheritdoc}
 */
class Exchange implements Binding_Installer_Interface
{
    ...
    {
        $channel->exchange_bind($binding->get_destination(), $exchange_name, $binding->get_topic(), false, $this->process_arguments($binding->get_arguments()));
    }
}